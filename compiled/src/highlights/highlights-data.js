...
window.HIGHLIGHTS_DATA = {
  studio: [{
    ...
    id: 'n068',
    maison: 'Chanel',
    piece: 'Classic Double Flap with Accessories',
    ...
    id: 'n180',
    maison: 'Louis Vuitton',
    piece: 'Pochette Accessories Mini',
  ...
  editorial: [{
    ...
    id: 'n118',
    maison: 'Louis Vuitton',
    piece: 'Takashi Murakami Pochette Accessories',
    ...
    id: 'n126',
    maison: 'Gucci x Chanel',
    piece: 'Bamboo Top x CC Cuba Flap',
