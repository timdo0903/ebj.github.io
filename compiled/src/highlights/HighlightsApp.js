...
function HighlightsApp() {
  ...
  return React.createElement(React.Fragment, null, React.createElement(window.SubpageNav, {
    current: "highlights"
  }), React.createElement(window.HighlightsHero, null), React.createElement(window.HighlightsGallery, null), React.createElement(window.Footer, null));
}
ReactDOM.createRoot(document.getElementById('root')).render(React.createElement(HighlightsApp, null));